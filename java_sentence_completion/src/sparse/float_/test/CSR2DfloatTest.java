...
public class CSR2DfloatTest {
	...
	public void testGet() {
		...
		Matrix2Dfloat m = new CSR2Dfloat(dok);
	...
	public void testMultiplyRandom() {
		...
		assertEquals(expected, new CSR2Dfloat(dok).multiply(vec));
	}
